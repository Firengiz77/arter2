...
<main class="main">
      <div class="section pt-60 pb-60 bg-primary">
        <div class="container-sub"> 
          <h1 class="heading-44-medium color-white mb-5">{{ $blog->title }}</h1>
      ...
      <section class="section pt-60 bg-white latest-new-white">
        <div class="container-sub"> 
          <div class="box-frature-image mb-60 wow fadeInUp"> 
            <div class="cardImage"> 
              <div class="datePost"> 
                <div class="heading-52-medium color-white">{{ date('d', strtotime($blog->created_at)) }}.</div>
                <p class="text-14 color-white">{{ date('Y,m', strtotime($blog->created_at)) }}</p>
              </div><img src="/public/{{ $blog->image }}" alt="luxride">
            </div>
          </div>
          <h2 class="heading-44-medium mb-30 wow fadeInUp">{{ $blog->title }}</h2>
          ...
          <div class="box-share-tags mt-50 wow fadeInUp"> 
            <div class="row align-items-center"> 
              ...
              @foreach ($blog->tags as $tag)
                    <a href="#"  class="btn btn-tag mr-10 mb-10">{{ $tag->title }}</a> 
                    @endforeach
