...
<main class="main">
      <div class="section pt-60 pb-60 bg-primary">
        <div class="container-sub"> 
          <h1 class="heading-44-medium color-white mb-5">{{ $service->name }}</h1>
          <div class="box-breadcrumb"> 
            <ul>
              <li> <a href="{{ route('index') }}">Home d</a></li>
      ...
      <section class="section mt-90">
        <div class="container-sub"> 
          ...
          @foreach ($service->attribute as  $item)
     
            <div class="col-lg-4 col-md-6 col-sm-6 mb-30"> 
              <div class="cardIconTitleDesc wow fadeInUp">
                <div class="cardIcon"><img src="/public/{{$item->image}}" alt="luxride"></div>
                <div class="cardTitle">
                  <h5 class="text-20-medium color-text">{{ $item->key }}</h5>
                </div>
                <div class="cardDesc">
                  <p class="text-16 color-text">{{ $item->value }}</p>
                </div>
              </div>
            </div>
      ...
      <section class="section">
        <div class="container-sub"> 
          <div class="mt-120"> 
            <h2 class="heading-44-medium mb-30 color-text title-fleet wow fadeInUp">{{ $service->name }}</h2>
