<footer class="footer">
          ...
          <div class="row mb-40">
            <div class="col-lg-3 width-20">
              ...
              <ul class="menu-footer wow fadeInUp">
                <li><a href="{{ route(app()->getLocale().'.about') }}">About us</a></li>
    ...
    <script src="{{ asset('/front/assets/js/vendors/modernizr-3.6.0.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/jquery-3.6.0.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/jquery-migrate-3.3.0.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/waypoints.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/wow.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/magnific-popup.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/perfect-scrollbar.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/select2.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/isotope.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/scrollup.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/swiper-bundle.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/noUISlider.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/slider.js')}}"></script>
    <!-- Count down-->
    <script src="{{ asset('/front/assets/js/vendors/counterup.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/jquery.countdown.min.js')}}"></script>
    <!-- Count down-->
    <script src="{{ asset('/front/assets/js/vendors/jquery.elevatezoom.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/slick.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/jquery-ui.js')}}"></script>
    <script src="{{ asset('/front/assets/js/vendors/jquery.timepicker.min.js')}}"></script>
    <script src="{{ asset('/front/assets/js/maine209.js?v=1.0.0')}}"></script>
  </body>
