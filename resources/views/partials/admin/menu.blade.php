                    ...
                    <div class="navbar-content">
                        <ul class="dash-navbar">
                            @if (Auth::user()->type == 1)
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'howitwork.index' || request()->is('admin/howitwork*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('howitwork.index') }}"
                                       class="dash-link {{ request()->is('howitwork') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext">{{ __('howitwork') }}</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'city.index' || request()->is('admin/city*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('city.index') }}"
                                       class="dash-link {{ request()->is('city') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
                                        <span class="dash-mtext">{{ __('city') }}</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'customer.index' || request()->is('admin/customer*') ? ' active dash-trigger' : 'collapsed' }}">
                                    <a href="{{ route('customer.index') }}"
                                       class="dash-link {{ request()->is('customer') ? 'active' : '' }}">
                                <span class="dash-micon">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg>
                                </span>
