...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                {{Form::open(array('url'=>'admin/customer','method'=>'post','enctype'=>'multipart/form-data'))}}
...
<div class='col-12'><div class='form-group'>{{ Form::label('profession', __('profession'), array('class' => 'form-label')) }}{{ Form::text('profession', null, array('class' => 'form-control', 'placeholder' => __('Enter profession'), 'required' => 'required')) }}</div></div>
