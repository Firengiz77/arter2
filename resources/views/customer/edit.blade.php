...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block text-white font-weight-bold mb-0 ">{{ __('Customer') }}</h5>
    </div>
@endsection
@section('breadcrumb')
...
{{ Form::text('name', $customer->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('profession', $customer->getTranslation('profession', $code), array('class' => 'form-control', 'placeholder' => __('Enter profession'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('desc', $customer->getTranslation('desc', $code), array('class' => 'form-control', 'placeholder' => __('Enter desc'), 'required' => 'required')) }}
</div>
</div>
