...
{{ Form::label('office', __('office'), array('class' => 'form-label')) }}
{{ Form::text('office', $contact->getTranslation('office', $code), array('class' => 'form-control', 'placeholder' => __('Enter office'), 'required' => 'required')) }}
</div>
</div>
...
<img src='/public/{{$contact->image}}' width='200' class='mt-2'/>
...
{{ Form::text('address', $contact->getTranslation('address', $code), array('class' => 'form-control', 'placeholder' => __('Enter address'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('phone', $contact->phone, array('class' => 'form-control', 'placeholder' => __('Enter phone'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('email', $contact->email, array('class' => 'form-control', 'placeholder' => __('Enter email'), 'required' => 'required')) }}
</div>
</div>
