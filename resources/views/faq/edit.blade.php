            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($faq, array('route' => array('faq.update', $faq->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('question', $faq->getTranslation('question', $code), array('class' => 'form-control', 'placeholder' => __('Enter question'), 'required' => 'required')) }}
</div>
</div>

                                <div class='col-12'>
<div class='form-group'>
{{ Form::label('answer', __('answer'), array('class' => 'form-label')) }}
{{ Form::text('answer', $faq->getTranslation('answer', $code), array('class' => 'form-control', 'placeholder' => __('Enter answer'), 'required' => 'required')) }}
</div>
</div>
