            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($city, array('route' => array('city.update', $city->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('name', $city->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required')) }}
</div>
</div>
