            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($counter, array('route' => array('counter.update', $counter->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
{{ Form::text('title', $counter->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required')) }}
</div>
</div>
...
<div class='col-12'>
<div class='form-group'>
{{ Form::label('number', __('number'), array('class' => 'form-label')) }}
{{ Form::text('number', $counter->number, array('class' => 'form-control', 'placeholder' => __('Enter number'), 'required' => 'required')) }}
</div>
</div>
