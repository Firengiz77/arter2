            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach (\App\Models\Utility::languages() as $code => $lang)
                    <div class="tab-pane fade {{$loop->first?"active show":""}}" id="pills-{{$code}}" role="tabpanel"
                        ...
                        {{Form::model($howitwork, array('route' => array('howitwork.update', $howitwork->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
...
<img src='/public/{{$howitwork->image}}' width='200' class='mt-2'/>
...
{{ Form::text('title', $howitwork->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required')) }}
</div>
</div>
...
{{ Form::text('desc', $howitwork->getTranslation('desc', $code), array('class' => 'form-control', 'placeholder' => __('Enter desc'), 'required' => 'required')) }}
</div>
</div>
