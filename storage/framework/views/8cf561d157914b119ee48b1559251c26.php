...
<?php $__env->startSection('action-btn'); ?>
    <a href="<?php echo e(route('blog.create')); ?>" class="btn btn-sm btn-icon  btn-primary me-2 text-white"  data-title="<?php echo e(__('Create New Blog')); ?>"  data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create')); ?>">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td><?php echo e($blog->title); ?></td>
                                        ...
                                        <td class="Action">
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('blog.edit', $blog->id)); ?>" class="btn btn-sm btn-icon  bg-light-secondary me-2"  data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/blog/index.blade.php ENDPATH**/ ?>