          ...
          <?php $__currentLoopData = $contact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-3 col-sm-6 mb-30">
              <div class="cardContact wow fadeInUp">
                <div class="cardImage mb-30"><img src="/public/<?php echo e($item->image); ?>" alt="luxride"></div>
                <div class="cardInfo">
                  <h6 class="heading-20-medium mb-10"><?php echo e($item->office); ?></h6>
                  <p class="text-16 mb-20"><?php echo e($item->address); ?></p>
                  <p class="text-16 mb-20"><?php echo e($item->phone); ?></p>
                  <p class="text-16"><?php echo e($item->email); ?></p>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('front.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/front/pages/contact.blade.php ENDPATH**/ ?>