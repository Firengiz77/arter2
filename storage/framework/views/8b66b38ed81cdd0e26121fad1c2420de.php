...
<img src='/public/<?php echo e($about->image); ?>' width='200' class='mt-2'/>
...
<?php echo e(Form::text('title', $about->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::textarea('desc', $about->getTranslation('desc', $code), array('class' => 'form-control  summernote-simple nicEdit', 'placeholder' => __('Enter desc'), 'required' => 'required'))); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::text('meta_title',$about->getTranslation('meta_title',
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::textarea('meta_description',$about->getTranslation('meta_description',
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::text('meta_keywords',$about->getTranslation('meta_keywords',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\arter2\resources\views/about/edit.blade.php ENDPATH**/ ?>