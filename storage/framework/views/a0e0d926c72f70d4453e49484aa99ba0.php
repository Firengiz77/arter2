...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">&copy; <?php echo e(date('Y')); ?>  <?php echo e(($footer_text) ? $footer_text :config('app.name', 'MarkUp')); ?> </span>
        </div>
    </div>
</footer>
...
<script type="text/javascript" src="<?php echo e(asset('custom/js/socialSharing.js')); ?>"></script>
<!-- Apex Chart -->
...
<?php /**PATH C:\xampp\htdocs\arter2\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>