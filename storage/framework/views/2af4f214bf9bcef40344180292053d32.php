<?php ($store_logo=\App\Models\Utility::get_file('uploads/partner_cover_image/')); ?>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($partner, array('route' => array('partner.update', $partner->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<img src='/public/<?php echo e($partner->image); ?>' width='200' class='mt-2'/>
...
<?php echo e(Form::text('title', $partner->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\arter2\resources\views/partner/edit.blade.php ENDPATH**/ ?>