...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <?php echo e(Form::open(array('url'=>'admin/sociallink','method'=>'post','enctype'=>'multipart/form-data'))); ?>
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="row">
                            ...
                            <div class='col-12'><div class='form-group'><?php echo e(Form::label('icon', __('Icon'), array('class' => 'form-label'))); ?><?php echo e(Form::text('icon', null, array('class' => 'form-control', 'placeholder' => __('Enter icon'), 'required' => 'required'))); ?></div></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\arter2\resources\views/sociallink/create.blade.php ENDPATH**/ ?>