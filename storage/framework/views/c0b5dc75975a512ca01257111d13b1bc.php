...
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_title', __('meta_title'), array('class' => 'form-label'))); ?><?php echo e(Form::text('meta_title', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_title'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_description', __('meta_description'), array('class' => 'form-label'))); ?><?php echo e(Form::text('meta_description', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_description'), 'required' => 'required'))); ?></div></div>
<div class='col-12'><div class='form-group'><?php echo e(Form::label('meta_keywords', __('meta_keywords'), array('class' => 'form-label'))); ?><?php echo e(Form::text('meta_keywords', null, array('class' => 'form-control', 'placeholder' => __('Enter meta_keywords'), 'required' => 'required'))); ?></div></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/blog/create.blade.php ENDPATH**/ ?>