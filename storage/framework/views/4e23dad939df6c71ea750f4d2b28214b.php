...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('/front/assets/imgs/template/favicon.png')); ?>">
    <link href="<?php echo e(asset('front/assets/css/stylee209.css?v=1.0.0')); ?>" rel="stylesheet">
  ...
  <body>
            ...
            <div class="header-nav">
              <nav class="nav-main-menu d-none d-xl-block">
                <ul class="main-menu">
                  ...
                  <li><a href="<?php echo e(route(app()->getLocale().'.about')); ?>">About</a></li>
                  <li><a href="fleet-list-4.html">Our Fleet</a></li>
                  <li><a href="<?php echo e(route(app()->getLocale().'.services')); ?>">Services</a></li>
                  <li><a href="<?php echo e(route(app()->getLocale().'.blogs')); ?>">Blog</a></li>
                  <li><a href="<?php echo e(route(app()->getLocale().'.contact')); ?>">Contact</a></li>
                </ul>
              </nav>
    ...
    </div><?php /**PATH C:\htdocs\arter2\resources\views/front/layout/header.blade.php ENDPATH**/ ?>