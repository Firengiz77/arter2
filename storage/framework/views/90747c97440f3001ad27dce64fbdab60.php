<?php ($store_logo=\App\Models\Utility::get_file('uploads/category_cover_image/')); ?>
...
<?php echo e(Form::text('name', $category->getTranslation('name', $code), array('class' => 'form-control', 'placeholder' => __('Enter name'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/category/edit.blade.php ENDPATH**/ ?>