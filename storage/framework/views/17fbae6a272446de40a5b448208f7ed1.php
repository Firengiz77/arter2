<?php ($store_logo=\App\Models\Utility::get_file('uploads/aboutdetail_cover_image/')); ?>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($aboutdetail, array('route' => array('aboutdetail.update', $aboutdetail->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<img src='/public/<?php echo e($aboutdetail->image); ?>' width='200' class='mt-2'/>
...
<?php echo e(Form::text('title', $aboutdetail->getTranslation('title', $code), array('class' => 'form-control', 'placeholder' => __('Enter title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('desc', $aboutdetail->getTranslation('desc', $code), array('class' => 'form-control', 'placeholder' => __('Enter desc'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/aboutdetail/edit.blade.php ENDPATH**/ ?>