...
<div class='col-12'>
<div class='form-group'>
<?php echo e(Form::label('category_id', __('category_id'), array('class' => 'form-label'))); ?>

<?php echo e(Form::select('category_id', $category,$service->getCategory->id, array('class' => 'form-control', 'placeholder' => __('Enter category_id'), 'required' => 'required'))); ?>
                                                        ...
                                                        <tr >
                                                           ...
                                                           <div style="display:flex">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="<?php echo e(route('serviceattribute.destroy',$attribute->id)); ?>" class="delete-icon"><i
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/service/edit.blade.php ENDPATH**/ ?>