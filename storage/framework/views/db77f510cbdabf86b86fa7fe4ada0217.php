            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first?"active show":""); ?>" id="pills-<?php echo e($code); ?>" role="tabpanel"
                        ...
                        <?php echo e(Form::model($faq, array('route' => array('faq.update', $faq->id), 'method' => 'PUT','enctype'=>'multipart/form-data'))); ?>
...
<?php echo e(Form::text('question', $faq->getTranslation('question', $code), array('class' => 'form-control', 'placeholder' => __('Enter question'), 'required' => 'required'))); ?>
                                ...
                                <div class='col-12'>
<div class='form-group'>
<?php echo e(Form::label('answer', __('answer'), array('class' => 'form-label'))); ?>

<?php echo e(Form::text('answer', $faq->getTranslation('answer', $code), array('class' => 'form-control', 'placeholder' => __('Enter answer'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\arter2\resources\views/faq/edit.blade.php ENDPATH**/ ?>