...
<?php echo e(Form::text('meta_title', $blog->getTranslation('meta_title', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_title'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('meta_description', $blog->getTranslation('meta_description', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_description'), 'required' => 'required'))); ?>
...
<?php echo e(Form::text('meta_keywords', $blog->getTranslation('meta_keywords', $code), array('class' => 'form-control', 'placeholder' => __('Enter meta_keywords'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\htdocs\arter2\resources\views/blog/edit.blade.php ENDPATH**/ ?>