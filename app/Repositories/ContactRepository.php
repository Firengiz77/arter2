...
class ContactRepository
{
    ...
    public function store($request): array
    {
        ...
        try {
            ...
            $contact->setTranslation('office', $request->lang??'az', $request->office);
    ...
    public function update($request, Contact $contact): array
    {
        ...
        try {
            ...
            $contact->setTranslation('office', $request->lang, $request->office);
                $image = $this->imageRepository->upload($request, "Contact", "image");
                if (!$image["status"]) {
                    return [
                        "status" => false,
                    ...
                    $contact->image = $image["data"];
                            ...
                            $contact->setTranslation('address', $request->lang, $request->address);          $contact->phone = $request->phone;
          $contact->email = $request->email;
