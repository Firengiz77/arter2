...
class ServiceAttributeRepository
{
    ...
    public function store($request): array
    {
        ...
        try {
            ...
            $serviceattribute->setTranslation('key', $request->lang??'az', $request->key);            $serviceattribute->setTranslation('value', $request->lang??'az', $request->value);          $serviceattribute->service_id = $request->service_id;
    ...
    public function update($request, ServiceAttribute $serviceattribute): array
    {
        ...
        try {
            ...
            $serviceattribute->setTranslation('key', $request->lang, $request->key);            $serviceattribute->setTranslation('value', $request->lang, $request->value);          $serviceattribute->service_id = $request->service_id;
